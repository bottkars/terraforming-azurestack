...
resource "azurestack_virtual_machine" "ops_manager_vm" {
  ...
  storage_os_disk {
    name          = "osdisk.vhd"
    vhd_uri       = "${azurestack_storage_account.ops_manager_storage_account.primary_blob_endpoint}vhds/${var.env_name}-opsman-osdisk.vhd"
...
resource "azurestack_virtual_machine" "optional_ops_manager_vm" {
  ...
  storage_os_disk {
    ...
    vhd_uri       = "${azurestack_storage_account.ops_manager_storage_account.primary_blob_endpoint}vhds/${var.env_name}-optional-opsmanosdisk.vhd"
